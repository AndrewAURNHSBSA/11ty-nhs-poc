...
Researchers get involved with project inception and planning. We review existing evidence, we gather assumptions and ideas from the team directly,  And we create research plans that show what we’ll do, why and how we’ll do it. We make sure the plan is achievable and allows us to do research at a sustainable pace. \
...
we include the team where we can in the generation of these materials\
...
we also work to make sure these recomendations and ideas are carried forward, or supporting them as they progress.\
...
We should always be vigilant about recruitment and make sure to make connections whenever they present themselves.\
...
**example from NHS digital below** -** we dont currently deal in cash, is this not just confusing? **
...
If a recruitment agency provides a participant who does not match the brief, we will pay the participant their incentive, but we will not pay the agency their recruitment fee. --- we dont used agencies yet- so should this be excised?
...
As soon as possible after the session, transfer any notes and recordings from paper and other devices to your NHSBSA provided laptop. And from your laptop to the NHSBSA Sharepoint or to the client’s research store. \
...
* record your laptop screen using Quicktime, Screenshot, camtasia, or OBS
